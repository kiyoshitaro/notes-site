...
- [Distributed System](#distributed-system)
  ...
  - [Fault Tolerance \& Recovery: cách duy trì hoạt động ổn định, nhất quán dữ liệu và hihg availability dù failures.](#fault-tolerance--recovery-cách-duy-trì-hoạt-động-ổn-định-nhất-quán-dữ-liệu-và-hihg-availability-dù-failures)
    - [Fault Tolerance: tập trung vào việc tiếp tục chạy khi lỗi](#fault-tolerance-tập-trung-vào-việc-tiếp-tục-chạy-khi-lỗi)
    - [Recovery : việc sửa chữa và quay lại trạng thái đúng (chủ yếu ở các stateful services)](#recovery--việc-sửa-chữa-và-quay-lại-trạng-thái-đúng-chủ-yếu-ở-các-stateful-services)
...
## Fault Tolerance & Recovery: cách duy trì hoạt động ổn định, nhất quán dữ liệu và hihg availability dù failures. 

### Fault Tolerance: tập trung vào việc tiếp tục chạy khi lỗi
...
### Recovery : việc sửa chữa và quay lại trạng thái đúng (chủ yếu ở các stateful services)
