...
contents_table: true
pinned: false
description: "Tổng quan ngôn ngữ lập trình"
cat: "compiler"
useKatex: false
---
# Tổng quan ngôn ngữ lập trình: từ thấp đến cao

> Tài liệu này hệ thống lại kiến thức về **cách máy tính chạy code của bạn** (low-level) và **cách bạn diễn đạt ý tưởng với máy** (high-level), với so sánh chi tiết giữa các ngôn ngữ phổ biến: C/C++, Rust, Go, Java, Python, JavaScript/Node.js.
---
...
9.  Type System
10. Primitive vs Object, Mutable vs Immutable
...
Ranh giới "compiler vs interpreter" là một câu hỏi sai. CPython có compiler bên trong (sinh bytecode `.pyc`). V8 có cả interpreter (Ignition) và JIT compiler (TurboFan/Maglev) => **"giai đoạn nào được thực hiện sớm, giai đoạn nào trì hoãn?"**
...
**Input**: chuỗi ký tự thô --> **Output**: danh sách token có nghĩa.
...
**Input**: stream token --> **Output**: cây cú pháp (parse tree hoặc AST — Abstract Syntax Tree).
...
### 9.3 Nominal vs Structural typing
...
### 10.1 Primitive (value type) vs Object (reference type)
...
6. **Fork/join, parallel collections** (Java, .NET).
...
### 12.4 Virtual Thread: Goroutine (Go) — M:N scheduling
...
### 12.5 Bảng tổng kết concurrency
